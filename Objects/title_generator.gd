...
func setup_from_file(noun_path: String, adjective_path: String, conjunction_path: String):
	nouns = FileHelper.file_to_string_array(noun_path)
	adjectives = FileHelper.file_to_string_array(adjective_path)
	conjunctions = FileHelper.file_to_string_array(conjunction_path)
